...
* [Model Optimization](9-model-optimization/README.md)
  * [🧮 Understanding Quantization](9-model-optimization/1-foundations.md)
  * [🔧 LLM-Compressor](9-model-optimization/2-llm-compressor.md)
  * [⚡ Advanced Quantization](9-model-optimization/3-advanced-quantization.md)
  * [🧪 Testing Pipeline](9-model-optimization/4-testing-pipeline.md)
  * [📊 Evaluation](9-model-optimization/5-evaluation.md)
