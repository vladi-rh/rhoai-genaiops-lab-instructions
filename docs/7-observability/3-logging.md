...
That's where distributed tracing comes in. Continue to **[Tracing](docs/7-observability/4-tracing.md)** to see how requests flow through Canopy's architecture 🔍
